        ...
        <div className="flex items-center justify-between h-20 lg:h-24">
          ...
          <div className="flex-shrink-0">
            <a 
              ...
              className="text-3xl lg:text-4xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent hover:scale-105 transition-transform duration-200"
            >
              MyPortfolio
            </a>
          </div>
            ...
            <div className="flex items-baseline space-x-10">
              {navItems.map((item, index) => (
                <a
                  ...
                  className={`px-4 py-3 text-lg lg:text-xl font-medium transition-colors duration-200 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 ${
                    isScrolled 
          ...
          <div className="md:hidden flex items-center space-x-3">
            ...
            <button
              ...
              className={`inline-flex items-center justify-center p-3 rounded-lg transition-colors duration-200 ${
                isScrolled 
